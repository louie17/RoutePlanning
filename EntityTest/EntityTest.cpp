...
int main()
{
	...
	VertexsVector vertexs{ std::make_shared<Vertex>(ver1),
	...
	PlatformsVector platforms{ std::make_shared<Platform>(p1),
	...
	EmittersVector emitiers{ std::make_shared<Emitter>(emitter1),std::make_shared<Emitter>(emitter2) };
	...
	WeaponsVector weapons{ std::make_shared<Weapon>(weapon1),std::make_shared<Weapon>(weapon2) };


	Site site1("Site1", 100, 32.3, 70.5);
	Site site2("Site2", 80, 32.9, 71.3);
	SitesVector sites{ std::make_shared<Site>(site1),std::make_shared<Site>(site2) };
	...
	OwnPlatformsVector oplatforms{ std::make_shared<OwnPlatform>(oPlatform1), std::make_shared<OwnPlatform>(oPlatform2) };

	Esm esm1("Esm1", 100, 20, 500, 12000, 200, 100), esm2("Esm2", 100, 20, 500, 12000, 200, 100);
	EsmsVector esms{ std::make_shared<Esm>(esm1),std::make_shared<Esm>(esm2) };
	...
	EcmsVector ecms{ std::make_shared<Ecm>(ecm1),std::make_shared<Ecm>(ecm2) };
	...
	RoutesVector routes{ std::make_shared<Route>(route1),std::make_shared<Route>(route2) };
	...
	EsmStrategyVector esmStrategies{ std::make_shared<EsmStrategy>(esmStrategy1),std::make_shared<EsmStrategy>(esmStrategy2) };
	...
	EcmStrategyVector ecmStrategies{ std::make_shared<EcmStrategy>(ecmStrategy1),std::make_shared<EcmStrategy>(ecmStrategy2) };
